<?php
/*
 * Template Name: Online Tricks Template
 * */
get_header(); ?>
    <!--
      middle area
             ...
             <div class="row">
                 ...
                 <div class="col-sm-8 tricks_left_side">
                     <div class="row">
                         ...
                         $args = array('post_type'=>'post','posts_per_page'=>'3','paged' => $paged1);
                         // the query
                         ...
                         <?php if ( $the_query->have_posts()): ?>
                             ...
                             <?php while ($the_query->have_posts()):
                                 ...
                                 <div class="col-sm-12 single_post">
                                     ...
                                     <div class="tag_area">
                                         <div class="tag_item">
                                             <?php echo get_avatar( get_the_author_meta( 'ID' ) , 32 ); ?><p>By:<i class="fa fa-user"></i> <a href="#"><?php the_author(); ?></a></p>
                                         </div>
                                         <div class="tag_item text-capitalize">
                                             <p>Tag:<i class="fa fa-tags"></i> <a href="#"><?php the_category(','); ?> </a>
                                             </p>
                                         </div>
                                     ...
                                     <br>
                                     <a href="<?php the_permalink(); ?>" class="more_post">Read More</a>
                                   </div>
